public class Ejercicio5_Transformacion {
    public static Nodo invertir(Nodo raiz) {
        ...
        // Invertimos los subárboles recursivamente
        Nodo izquierdoInvertido = invertir(raiz.izquierdo);
        Nodo derechoInvertido = invertir(raiz.derecho);
        
        // Intercambiamos los hijos del nodo actual
        raiz.izquierdo = derechoInvertido;
        raiz.derecho = izquierdoInvertido;
